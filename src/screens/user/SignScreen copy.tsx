...
export default function SmartSignInScreen() {
    ...
    const handleSignIn = async () => {
        ...
        try {
            setIsLoading(true);
            const userCredential = await signInWithEmailAndPassword(authInstance, email.trim().toLowerCase(),password.trim());
        ...
        <View style={styles.container}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                ...
                >
                    ...
                    {/* Welcome text */}
                    <Text style={styles.title}>Welcome to invoAIce!</Text>
                    <Text style={styles.subtitle}>Sign in for a smarter invoicing experience...</Text>
